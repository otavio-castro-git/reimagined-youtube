...
def enviar_email_codigo(destinatario: str, codigo: str) -> bool:
    ...
    msg["Subject"] = "Seu código de verificação - BeatTube"
    msg["From"]    = remetente
    msg["To"]      = destinatario

    texto_plano = (
        f"Seu código de verificação do BeatTube é: {codigo}\n\n"
    ...
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color:#ff6600;">Beat<span style="color:#111;">Tube</span></h2>
        <p>Olá!</p>
